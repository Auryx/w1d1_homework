...
# princess_leia.txt
# storm_trooper.txt
$ mkdir death_star && cd death_star && touch darth_vader.txt && touch princess_leia.txt && touch storm_trooper.txt
...
cd ..
cd death_star 
cp storm_trooper.txt ~/Seir-Kale/Unit1/Week1/first_homework/galaxy_far_far_away/tatooine/
...
cd millenium_falcon
mv luke.txt princess_leia.txt ..
cd ..
mv luke.txt princess_leia.txt x_wing/
